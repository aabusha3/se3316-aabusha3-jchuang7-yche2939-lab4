...
function updateDone(id, newListInfo){
  result.value[id].name = newListInfo.Name;
  result.value[id].desc = newListInfo.Desc;
  result.value[id].tracks = newListInfo.Tracks;
  result.value[id].dateLastModed = newListInfo.DLM;
}
...
async function updateVis(id, name, vis){
  result.value[id].public = !result.value[id].public;
